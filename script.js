...
vara[0] = new Vara(
  ...
  [
    ...
    {
      text: "Sekali lagi kita tidak dapat bertemu.",
      y: 40,
      x: posX,
      duration: 4000
    },
...
vara[1] = new Vara(
  ...
  [
    ...
    {
      text: "Walaupun sudah lama tidak bertatap muka, pasti ada kesalahan yang terjadi.",
      y: 40,
      x: posX,
      duration: 4000
    },
    {
      text: "Berharap bertemu langsung dengan mu untuk mengatakan...",
      y: 10,
      x: posX,
      duration: 3500
    }
...
vara[2] = new Vara(
  ...
  [
    ...
    {
      text: "Mohon Maaf yang sebesar besarnya atas perkataan maupun perilaku yang tidak mengenakan hati.",
      y: 40,
      x: posX,
      duration: 4000
    },
